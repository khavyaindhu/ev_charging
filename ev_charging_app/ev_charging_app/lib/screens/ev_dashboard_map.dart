...
class LocationDetailsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // Debugging: Print the chargingStations being passed to MapScreen
    print("LocationDetailsPage -> ChargingStations: $chargingStations");
...
class MapScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Debugging: Log both defaultLocations and chargingStations
    print("MapScreen -> DefaultLocations: $defaultLocations");
    print("MapScreen -> ChargingStations: $chargingStations");
